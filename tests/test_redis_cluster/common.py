...
redis_trib = os.path.abspath('redis-trib.rb')
...
all_redis = [
        ...
        RedisClusterServer('127.0.0.1', 2102, '/tmp/r/redis-2102/', CLUSTER_NAME, 'redis-2104'),
        RedisClusterServer('127.0.0.1', 2103, '/tmp/r/redis-2103/', CLUSTER_NAME, 'redis-2105'),
        ]
...
def setup():
    ...
    os.system("ruby %s create --replicas 1 %s" % (redis_trib, cluster_servers))
